(function( $ ) {
  ...
  function hideRecoverPasswordForm() {
   ...
   geckoShopify.cart_tls_ship = function () {
      var Timeout,
          Cartdiscode = $('#Cartdiscode'),
          localCartdiscode = localStorage.getItem('Cartdiscode');
        
        $('#couponcode').val(localCartdiscode);
        ...
        if (sp_nt_storage && Cartdiscode.length > 0) { 

			$(".js_cart_save").click(function(e) {
			    localStorage.setItem('Cartdiscode', Cartdiscode.val());
			});
			Cartdiscode.val(localCartdiscode);
        }
